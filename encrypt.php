  ...
  <body>
    ...
    <nav>
      ...
      <ul>
        ...
        <li><a class="active" href="encrypt.php">Encrypt</a></li>
              ...
              <div class="col-lg-6" style="margin-top: 30px;">
                ...
                <div class="form-row" style="display: flex;">
                  ...
                  <div class="form-row" style="display: flex; justify-content: center;">      
                    <button class="btn btn-primary" name="send" id="sendMsg"><i class="bi bi-send-fill"></i> Encrypt</button>
                  </div>
                </div>   
            ...
            <div class="col-lg-6" style="margin-top: 30px;margin-bottom: 60px;">
                ...
                <div class="form-row">
                  <label for="message">Encrypted Message:</label>
                    <br>
                      <textarea name="message" style="width: 100%; "rows="10" id="encrpyted_message" maxlength="100" required disabled></textarea>
                </div>
                <br>
                <br>
                <br>
                    <div class="form-row" style="display: flex; justify-content: center;">        
                      <button class="btn btn-primary" id="copyMessage"><i class="bi bi-clipboard"></i> Copy</button>
                      &nbsp;
    ...
    <script type="text/javascript">
        ...
        $('#sendMsg').click(function(){
          ...
          $.ajax({
              ...
              success: function (response) {
                $('#encrpyted_message').val(response);
                $('#message').val('');
                $('#key').val('');
              }
          });     
        ...
        $('#copyMessage').click(function (){
          window.localStorage.setItem('message',$('#encrpyted_message').val());
          // navigator.clipboard.writeText(input);
        });

        $('#clearMessage').click(function (){
          $('#encrpyted_message').val('');
        });
